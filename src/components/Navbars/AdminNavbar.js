...
const AdminNavbar = ({ brandText, toggleSidebar, isSidebarOpen }) => {
    ...
    <UncontrolledDropdown nav inNavbar>
      ...
      >
        <DropdownItem header tag="div" style={{ padding: "12px 16px", borderBottom: "1px solid #e2e8f0" }}>
          <h6 className="m-0" style={{ color: "#2d3748", fontWeight: "600", fontSize: "14px" }}>
            Notifications
          </h6>
  ...
  return (
    <>
      ...
      <Navbar
        ...
        id="navbar-main"
        style={{
          width: isSidebarOpen && !isMobile ? "calc(100vw - 280px)" : "100%",
          ...
          position: "fixed",
          top: 0,
          left: isSidebarOpen && !isMobile ? "280px" : "0",
          right: 0,
          zIndex: 1100,
            ...
            <UncontrolledDropdown nav inNavbar>
              ...
              >
                ...
                >
                  <h6
                    className="m-0"
                    style={{ color: "#2d3748", fontWeight: "600", fontSize: "14px" }}
                  >
                    Welcome! 👋
                  </h6>
