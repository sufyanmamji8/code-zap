...
//           phoneNumber,
//           senderName: names[phoneNumber] || msg.senderName || phoneNumber,
...
//               {/* Keep existing message input section */}
//               <div style={{ 
//                 padding: "12px 16px",
...
//         // If it's a new page, append contacts
//         // If it's a refresh (page 1), replace contacts
//         setContacts(prev => {
//           if (pageNum === 1) {
//             return newContacts;
//           } else {
//             // Filter out any duplicates when adding new contacts
...
//           parseInt(b.currentStatusTimestamp) - parseInt(a.currentStatusTimestamp)
//         );
...
//                     timestamp: latestMessage.currentStatusTimestamp
//                   }
//                 : contact
//             )
//           );
...
//   // Find the latest data for this contact from uniqueUsers
...
//             }}
//           >
//             {latestData.lastMessage} {/* Show the latest message */}
//           </div>
//           <div style={{ fontSize: "11px", color: "#888" }}>
